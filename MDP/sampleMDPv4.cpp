 ...
 * Version 4: parse solutions by dimensions
 */
int main( int argc, char** argv )
{
    ...
    // define costs
    double CA = 0.5; // activation cost
    double CD = 0.5; // deactiavtion cost
    ...
    int B = 2; // maximum buffer for number of requests
    int N = 2; // maximum number of nodes
